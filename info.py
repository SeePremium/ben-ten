...
URL = "https://benten-1gj4.onrender.com{}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://benten-1gj4.onrender.com{}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://benten-1gj4.onrender.com{}/".format(FQDN)
else:
    URL = "https://benten-1gj4.onrender.com/{}/".format(FQDN)
